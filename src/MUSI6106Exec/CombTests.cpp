...
// -----------------------------------------------------TESTS----------------------------------------------------------
/*
 * Make sure that the test_audio/ folder is present in same directory as the executable before running tests.
 * A copy of test_audio/ can be found in /test/Ass1/
*/
// --------------------------------------------------------------------------------------------------------------------
...
int test5() {
    ...
    std::cout << "---------------" << std::endl;
    std::cout << "Running Test 5: Negative Delay and Gain" << std::endl;
    std::cout << "---------------" << std::endl << std::endl;
    ...
    std::cout << std::endl << "Test 5 completed" << std::endl;
    std::cout << "---------------" << std::endl << std::endl;
    return 0;
    return 0;
}